    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-sky-100 to-indigo-100">
      <div className="flex w-full max-w-4xl overflow-hidden rounded-lg bg-white shadow-xl">
        ...
        <div className="w-full p-8 md:w-1/2">
          <h2 className="mb-6 text-center text-2xl font-semibold text-indigo-700">Tutor Signup</h2>
          ...
          <div className="mt-4 text-center">
            <p className="text-sm">
              ...
              <Link to="/tutor/login" className="font-medium text-indigo-600 hover:underline">
                Login here
              </Link>
            </p>
          </div>
