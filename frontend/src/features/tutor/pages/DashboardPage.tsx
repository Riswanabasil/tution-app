...
//   return (
//     <div className="rounded-2xl border bg-white p-4 shadow-sm">
//       <div className="mb-3 font-medium text-gray-800">Top Courses (by sales)</div>
...
//   return (
//     <div className="rounded-2xl border bg-white p-4 shadow-sm">
//       <div className="mb-3 font-medium text-gray-800">Recent Enrollments</div>
//       <div className="overflow-x-auto">
//         <table className="min-w-full text-sm">
//           <thead className="bg-gray-50 text-left text-gray-600">
//             <tr>
...
//         <div className="font-medium text-gray-800">My Courses Overview</div>
...
//               <th className="p-3">Enrollments (range)</th>
//               <th className="p-3">Revenue (range)</th>
//             </tr>
//           </thead>
//           <tbody>
//             {items.map((c) => (
...
//                 <td className="p-3">{c.enrollmentsInRange}</td>
//                 <td className="p-3">₹{c.revenueInRange.toLocaleString()}</td>
//               </tr>
//             ))}
//             {items.length === 0 && (
//               <tr>
...
//         <div className="text-2xl font-semibold text-gray-900">Tutor Dashboard</div>
...
//           <div className="mt-1 text-3xl font-semibold">₹{(kpis?.walletBalance ?? 0).toLocaleString()}</div>
//         </div>
//         <div className="rounded-2xl border bg-white p-4 shadow-sm">
//           <div className="text-sm text-gray-500">Active Students (range)</div>
//           <div className="mt-1 text-3xl font-semibold">{kpis?.activeStudents ?? 0}</div>
//         </div>
//         <div className="rounded-2xl border bg-white p-4 shadow-sm">
//           <div className="text-sm text-gray-500">Payment Issues (24h)</div>
//           <div className="mt-1 text-3xl font-semibold">{kpis?.paymentIssues24h ?? 0}</div>
//         </div>
//       </div>
...
//       <div className="rounded-2xl border bg-white p-4 shadow-sm">
//         <div className="mb-3 font-medium text-gray-800">Pending Approvals</div>
...
//             </li>
//           ))}
//           {pending.length === 0 && <div className="text-sm text-gray-500">No pending courses</div>}
//         </ul>
//       </div>
//     </div>
//   );
