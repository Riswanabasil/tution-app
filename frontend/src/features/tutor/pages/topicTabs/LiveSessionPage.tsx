...
//   useEffect(() => {
//     if (!sessionId || !token) {
//       setError("Missing session or auth token");
//       setConnecting(false);
//       return;
//     }
...
//         // Server sends who is already in the room → we call them (send offer)
//         socket.on("room:peers", async (peers: PeerInfo[]) => {
//           for (const p of peers) await callPeer(p.socketId);
//           setConnecting(false);
//         });

//         // Someone new joins (they will call us)
