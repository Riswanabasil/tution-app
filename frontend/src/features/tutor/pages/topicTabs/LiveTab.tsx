...
//     const payload = { title, description, scheduledAt: scheduledAt || undefined };
//     try {
//       if (editSession) {
...
//     // redirect tutor directly into live room
...
//       {/* List */}
//       {sessions.length === 0 ? (
//         <div className="py-16 text-center text-slate-500">No sessions yet for this topic.</div>
//       ) : (
...
//                     title="Start session and enter the room"
//                   >
//                     Start Session
//                   </button>
//                 )}
