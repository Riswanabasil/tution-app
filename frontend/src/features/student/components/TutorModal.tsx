  ...
  return (
    ...
    >
      <div
        ...
        onClick={onClose}
      />
      <div className="relative z-10 w-full max-w-xl rounded-2xl bg-white p-4 sm:p-6 shadow-2xl">
        <div className="mb-4 flex items-start justify-between">
          <h3 id="tutor-modal-title" className="text-lg sm:text-xl font-semibold text-gray-800">
            Tutor Details
          </h3>
          <button
            onClick={onClose}
            aria-label="Close"
            className="rounded-full p-1 text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-200"
            type="button"
          >
            ✕
          </button>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div
              className="h-12 w-12 animate-spin rounded-full border-b-2 border-gray-300"
              role="status"
              aria-label="Loading"
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-4 flex justify-end">
              <button
                onClick={onClose}
                className="rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-300"
                type="button"
              >
                Close
              </button>
