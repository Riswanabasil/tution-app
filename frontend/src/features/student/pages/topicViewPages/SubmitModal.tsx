...
//       getSubmissionDetails(assignment._id).then((res) => {
...
//         {isViewOnly && existingFileUrl ? (
//           <div className="mt-4">
//             <Typography variant="subtitle2">Submitted File:</Typography>
//             <a
...
//         ) : !isViewOnly && (
//           <div className="mt-4">
//             <InputLabel>Upload File (optional)</InputLabel>
//             <input
//               type="file"
