...
const NoteTab = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 sm:p-6">
      <div className="mx-auto max-w-4xl">
        <div className="mb-6">
          <h2 className="mb-2 text-2xl sm:text-3xl font-bold text-gray-800">Study Notes</h2>
          <div className="h-1 w-24 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" />
        </div>

        {notes.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12">
            <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-indigo-200">
              <svg
            ...
            <h3 className="mb-2 text-lg sm:text-xl font-semibold text-gray-700">No Notes Available</h3>
            <p className="max-w-md text-center text-gray-500">
              No study notes have been uploaded for this topic yet. Check back later for new
              materials.
            </p>
                ...
                <div className="space-y-3 overflow-hidden">
                  {note.pdfUrls.map((url, i) => (
                    <a
                      ...
                      className="group/link flex w-full items-center justify-between rounded-xl border border-blue-100 bg-gradient-to-r from-blue-50 to-indigo-50 p-3 transition-all duration-200 hover:border-blue-200 hover:from-blue-100 hover:to-indigo-100"
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-red-500 to-red-600">
                          <svg
                      ...
                      <div className="flex items-center gap-2 text-blue-600 group-hover/link:text-blue-700">
                        <span className="text-sm font-medium">Open</span>
                        <svg
                          className="h-4 w-4 transform transition-transform duration-200 group-hover/link:translate-x-0.5"
                          fill="none"
