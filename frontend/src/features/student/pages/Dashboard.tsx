    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-8 text-center sm:mb-12">
          <h1 className="mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-3xl sm:text-5xl font-bold text-transparent">
            Explore Courses
          </h1>
          <p className="mx-auto max-w-2xl text-sm sm:text-lg text-gray-600">
            Discover amazing courses and enhance your skills with our comprehensive learning
            platform
          </p>
        </div>
        ...
        {/* Search Section */}
        <div className="mb-6 rounded-2xl border border-gray-100 bg-white p-4 sm:p-6 shadow-xl">
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full rounded-xl border-2 border-gray-200 py-3 pl-10 pr-4 text-base sm:text-lg transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
              aria-label="Search courses"
            />
          </div>

          {/* Filters - stacked on small screens */}
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            {/* Semester Filters */}
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                <Filter className="h-5 w-5 text-gray-600" />
                <span className="font-semibold text-gray-700 text-sm">Filter by Semester:</span>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                {Array.from({ length: 8 }).map((_, i) => (
                  <button
                    ...
                    className={`transform rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-200 ${
                      semester === i + 1
                        ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg'
                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                    type="button"
                    aria-pressed={semester === i + 1}
                  >
                    Sem {i + 1}
                  </button>
                ))}
                <button
                  ...
                  type="button"
                  aria-pressed={semester === undefined}
                >
                  All
                </button>
              </div>
            ...
            <div className="space-y-3">
              ...
              <select
                ...
                value={sortBy || ''}
                className="rounded-xl border-2 border-gray-200 bg-white px-3 py-2 text-sm shadow-sm transition-all focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
        ...
        {loading && (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-lg font-medium text-gray-600">Loading amazing courses...</p>
            </div>
          </div>
        )}
            ...
            <div className="rounded-2xl border border-gray-100 bg-white p-4 sm:p-6 shadow-lg">
              <div className="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
                <button
                  onClick={() => setPage((p) => Math.max(1, p - 1))}
                  disabled={page <= 1}
                  className={`flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition-all sm:w-auto ${
                    page <= 1
                      ? 'cursor-not-allowed bg-gray-100 text-gray-400'
                      : 'transform bg-gradient-to-r from-gray-500 to-gray-600 text-white shadow-lg hover:scale-105 hover:from-gray-600 hover:to-gray-700 hover:shadow-xl'
                  }`}
                ...
                <div className="flex items-center justify-center gap-3">
                  <div className="rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-2 text-sm font-bold text-white">
                    Page {page} of {totalPages}
                  </div>
                </div>
