      ...
      <div className="bg-white shadow-lg rounded-lg w-full max-w-md p-8">
        ...
        {errorMsg && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4">
            <strong className="font-bold">Error: </strong>
            <span className="block sm:inline">{errorMsg}</span>
            <span onClick={() => setErrorMsg("")} className="absolute top-0 bottom-0 right-0 px-4 py-3 cursor-pointer">×</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="text-right">
            <Link to="/student/forgot-password" className="text-sm text-indigo-600 hover:underline">Forgot password?</Link>
          </div>

          <button
            type="submit"
            className="w-full bg-indigo-600 text-white py-2 rounded hover:bg-indigo-700 transition disabled:opacity-70"
            disabled={loading}
          >
        ...
        <div className="mt-4 text-center">
          <p className="text-sm">
            Don't have an account?{" "}
            <Link to="/student/register" className="text-indigo-600 hover:underline font-medium">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
