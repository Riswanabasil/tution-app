...
const profile_1 = require("../../../mappers/student/profile");
class StudentService {
    ...
    loginStudentService(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const accessToken = (0, GenerateToken_1.generateAccessToken)(student._id.toString(), student.email, student.role, student.name);
            const refreshToken = (0, GenerateToken_1.generateRefreshToken)(student._id.toString(), student.email, student.role);
            return {
                accessToken,
                refreshToken,
                student: {
    ...
    googleLoginStudentService(idToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const accessToken = (0, GenerateToken_1.generateAccessToken)(student._id.toString(), student.email, student.role);
            const refreshToken = (0, GenerateToken_1.generateRefreshToken)(student._id.toString(), student.email, student.role);
            return {
                accessToken,
                refreshToken,
    ...
    getProfile(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!student)
                throw new Error('Student not found');
            // return student;
            const dto = profile_1.StudentMapper.toProfileDTO(student);
            return dto;
        });
    }
