...
class StudentCourseService {
    ...
    listApproved(page_1, limit_1) {
        return __awaiter(this, arguments, void 0, function* (page, limit, search = '', semester, sortBy) {
            ...
            const courses = yield Promise.all(raw.map((c) => __awaiter(this, void 0, void 0, function* () {
                const obj = c.toObject ? c.toObject() : c;
                obj.thumbnail = obj.thumbnailKey ? yield (0, s3Presign_1.presignGetObject)(obj.thumbnailKey) : undefined;
                return obj;
            })));
            return {
                courses,
    ...
    fetchCourseWithModules(courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const demoVideoUrl = obj.demoKey
                ...
                : undefined;
            const enrichedModules = yield Promise.all(modules.map((m) => __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                tutorEducation: ((_a = tutor.verificationDetails) === null || _a === void 0 ? void 0 : _a.education) || '',
                tutorExperience: ((_b = tutor.verificationDetails) === null || _b === void 0 ? void 0 : _b.experience) || '',
                tutorSummary: ((_c = tutor.verificationDetails) === null || _c === void 0 ? void 0 : _c.summary) || '',
