...
class StudentVideoService {
  ...
  listByTopicForStudent(topicId, studentId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const withUrls = yield Promise.all(
        videos.map((v) =>
      ...
      const progresses = yield this.progressRepo.findByStudentAndVideoIds(
        studentId,
        withUrls.map((v) => String(v._id)),
      );
      const map = new Map(progresses.map((p) => [String(p.video), p]));
      return withUrls.map((v) =>
  ...
  upsertProgress(input) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this.progressRepo.upsertAndMerge({
        ...
        durationSecDb:
          (_a = video === null || video === void 0 ? void 0 : video.durationSec) !== null &&
          _a !== void 0
            ? _a
            : undefined,
      });
