...
class StudentAssignmentService {
  ...
  listAssignmentsWithStatus(topicId, studentId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const submissions = yield this.submissionRepo.findByStudentAndAssignments(
        studentId,
        assignmentIds,
      );
  ...
  getSubmission(assignmentId, studentId) {
    return __awaiter(this, void 0, void 0, function* () {
      const submission = yield this.submissionRepo.findByAssignmentAndStudent(
        assignmentId,
        studentId,
      );
  ...
  updateSubmissionByAssignment(assignmentId, studentId, data) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const existing = yield this.submissionRepo.findByAssignmentAndStudent(
        assignmentId,
        studentId,
      );
      if (!existing) {
      ...
      const submittedFile = `https://${process.env.S3_BUCKET_NAME}.s3.amazonaws.com/${encodeURIComponent(fileKey)}`;
      return yield this.submissionRepo.updateSubmissionByAssignmentAndStudent(
        assignmentId,
        studentId,
        response,
        submittedFile,
