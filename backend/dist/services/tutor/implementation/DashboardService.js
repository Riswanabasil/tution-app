...
class TutorDashboardService {
    ...
    getKpis(tutorId, range) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [newEnrollments, activeStudents, revInRange, revToday, revMtd, walletBalance, paymentIssues24h,] = yield Promise.all([
    ...
    getMyCoursesOverview(tutorId, range, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const list = yield this.courses.listByTutor(tutorId, {
                ...
                limit: (_a = opts === null || opts === void 0 ? void 0 : opts.limit) !== null && _a !== void 0 ? _a : 50,
                skip: (_b = opts === null || opts === void 0 ? void 0 : opts.skip) !== null && _b !== void 0 ? _b : 0,
            });
            const totalFilter = { tutor: tutorId };
            if (opts === null || opts === void 0 ? void 0 : opts.status)
                totalFilter.status = opts.status;
            ...
            const items = list.map((c) => {
                ...
                return {
                    ...
                    enrollmentsInRange: (_a = s === null || s === void 0 ? void 0 : s.enrollments) !== null && _a !== void 0 ? _a : 0,
                    revenueInRange: (_b = s === null || s === void 0 ? void 0 : s.revenue) !== null && _b !== void 0 ? _b : 0,
                };
            });
            return { items, total };
        });
