...
const dashboardService = new AdminDashboardService_1.AdminDashboardService(studentRepo, tutorRepo, courseRepo, enrollmentRepo);
...
//Student
router.get('/students', adminAuthMiddleware_1.adminAuthMiddleware, studentController.getAllStudents.bind(studentController));
router.patch('/student/:id/block', adminAuthMiddleware_1.adminAuthMiddleware, studentController.blockStudent.bind(studentController));
//tutor
router.get('/tutors', adminAuthMiddleware_1.adminAuthMiddleware, tutorController.getAllTutors.bind(tutorController));
router.get('/tutor/:id', adminAuthMiddleware_1.adminAuthMiddleware, tutorController.getTutorById.bind(tutorController));
router.patch('/tutor/:id/status', adminAuthMiddleware_1.adminAuthMiddleware, tutorController.updateTutorStatus.bind(tutorController));
//course
router.get('/courses', adminAuthMiddleware_1.adminAuthMiddleware, courseController.listAll);
router.patch('/courses/:id/status', adminAuthMiddleware_1.adminAuthMiddleware, courseController.updateStatus);
//dashboard
router.get('/dashboard/kpis', adminAuthMiddleware_1.adminAuthMiddleware, dashboardController.getKpis);
router.get('/dashboard/revenue', adminAuthMiddleware_1.adminAuthMiddleware, dashboardController.getRevenueTrend);
router.get('/dashboard/enrollments', adminAuthMiddleware_1.adminAuthMiddleware, dashboardController.getEnrollmentTrend);
router.get('/dashboard/top-courses', adminAuthMiddleware_1.adminAuthMiddleware, dashboardController.getTopCourses);
router.get('/dashboard/approval-queues', adminAuthMiddleware_1.adminAuthMiddleware, dashboardController.getApprovalQueues);
