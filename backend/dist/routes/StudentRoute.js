...
const reviewController_1 = __importDefault(require("../controllers/student/implementation/reviewController"));
...
const studentOtpService = new StudentOtpService_1.StudentOtpService(studentOtpRepository, studentRepo);
const enrollRepository = new EnrollmentRepository_1.EnrollmentRepository();
const studentService = new StudentService_1.StudentService(studentRepo, hasher, otpService, tokenService, enrollRepository);
const studentController = new StudentControllers_1.StudentController(studentService, studentOtpService, otpService);
...
const courseService = new CourseService_1.StudentCourseService(courseRepo, moduleRepo, tutorRepo, topicRepo);
...
const paidCourseService = new PaidCourseService_1.PaidCourseService(moduleRepo, topicRepo, noteRepo);
...
const assignmentService = new StudentAssignmentService_1.StudentAssignmentService(assignmentRepo, SubmissionRepo);
const assignmentController = new AssignmentController_1.AssignmentController(assignmentService);
const passwordService = new PasswordResetService_1.PasswordResetService(studentOtpRepository, studentRepo, otpService);
...
router.post('/verify-otp', authMiddleware_1.authMiddleware, studentController.verifyStudentOtp.bind(studentController));
router.post('/resend-otp', authMiddleware_1.authMiddleware, studentController.resendOtp.bind(studentController));
...
//profile
router.get('/profile', authMiddleware_1.authMiddleware, studentController.getProfile.bind(studentController));
router.put('/profile', authMiddleware_1.authMiddleware, studentController.updateProfile.bind(studentController));
router.put('/profile/password', authMiddleware_1.authMiddleware, studentController.changePassword.bind(studentController));
router.get('/profile/upload-url', studentController.getUploadUrl);
//course
router.get('/courses', authMiddleware_1.authMiddleware, courseController.list.bind(courseController));
router.get('/courses/:courseId', courseController.getCourseDetails.bind(courseController));
//payment
router.post('/payments/order', authMiddleware_1.authMiddleware, paymentController.createOrder.bind(paymentController));
router.post('/payments/verify', authMiddleware_1.authMiddleware, paymentController.verifyPayment.bind(paymentController));
router.post('/payments/cancel', authMiddleware_1.authMiddleware, paymentController.cancelPayment.bind(paymentController));
router.get('/stats', authMiddleware_1.authMiddleware, paymentController.getStats.bind(paymentController));
router.get('/history', authMiddleware_1.authMiddleware, paymentController.getHistory.bind(paymentController));
router.post('/payments/retry', authMiddleware_1.authMiddleware, paymentController.retryOrder.bind(paymentController));
//paid Course
router.get('/mycourses', authMiddleware_1.authMiddleware, paymentController.getMyCourses.bind(paymentController));
router.get('/modules/:courseId', authMiddleware_1.authMiddleware, paidCourseController.getModulesByCourse.bind(paidCourseController));
router.get('/topics/:moduleId', authMiddleware_1.authMiddleware, paidCourseController.getTopicsByModule.bind(paidCourseController));
router.get('/notes/:topicId', authMiddleware_1.authMiddleware, paidCourseController.getNotes.bind(paidCourseController));
router.get('/assignments/:topicId', authMiddleware_1.authMiddleware, assignmentController.getAssignmentsForStudent.bind(assignmentController));
router.get('/submissions/presigned-url', assignmentController.generatePresignedUrl);
router.post('/submissions/:assignmentId', authMiddleware_1.authMiddleware, assignmentController.createSubmissionController.bind(assignmentController));
router.get('/submissions/:assignmentId', authMiddleware_1.authMiddleware, assignmentController.getStudentSubmissionByAssignment.bind(assignmentController));
router.put('/submission/:assignmentId', authMiddleware_1.authMiddleware, assignmentController.updateSubmissionByAssignment.bind(assignmentController));
//video
router.get('/topics/:topicId/videos', authMiddleware_1.authMiddleware, videoCtrl.listByTopic.bind(videoCtrl));
router.post('/videos/:videoId/progress', authMiddleware_1.authMiddleware, videoCtrl.upsertProgress.bind(videoCtrl));
//review
...
router.get('/courses/:courseId/reviews', authMiddleware_1.authMiddleware, reviewCtrl.listByCourse.bind(reviewCtrl));
router.get('/courses/:courseId/reviews/stats', authMiddleware_1.authMiddleware, reviewCtrl.stats.bind(reviewCtrl));
...
router.get('/courses/:courseId/reviews/mine', authMiddleware_1.authMiddleware, reviewCtrl.getMine.bind(reviewCtrl));
//live
router.get('/topic/:topicId/livesession', authMiddleware_1.authMiddleware, liveController.listByTopic.bind(liveController));
