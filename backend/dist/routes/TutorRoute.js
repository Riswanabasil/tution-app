...
const assService = new AssignmentService_1.AssignmentService(
  assRepo,
  topicRepo,
  moduleRepo,
  courseRepo,
...
const enrollmentService = new DashboardService_1.TutorDashboardService(
  courseRepo,
  enrollmentRepo,
  tutorRepo,
);
...
const liveService = new LiveSessionService_1.LiveSessionService(
  liveRepo,
  topicRepo,
  moduleRepo,
  courseRepo,
...
router.get(
  ...
  tutorController.getProfile.bind(tutorController),
);
router.put(
  '/profile',
  authMiddleware_1.authMiddleware,
...
router.get(
  '/profile/stats',
  authMiddleware_1.authMiddleware,
  tutorController.getStats.bind(tutorController),
);
router.get(
  '/profile/courses',
  authMiddleware_1.authMiddleware,
  tutorController.getMyCourses.bind(tutorController),
);
...
router.get(
  '/videos/upload-url',
  authMiddleware_1.authMiddleware,
  videoCtrl.getVideoUploadUrl.bind(videoCtrl),
);
...
router.get(
  '/dashboard/revenue',
  authMiddleware_1.authMiddleware,
  enrollmentController.getRevenueTrend,
);
router.get(
  '/dashboard/enrollments',
  authMiddleware_1.authMiddleware,
  enrollmentController.getEnrollmentTrend,
);
router.get(
  '/dashboard/top-courses',
  authMiddleware_1.authMiddleware,
  enrollmentController.getTopCourses,
);
router.get(
...
router.get(
  ...
  authMiddleware_1.authMiddleware,
  enrollmentController.getMyCoursesOverview,
);
router.get(
...
router.post(
  '/:topicId/livesession',
  authMiddleware_1.authMiddleware,
  liveController.create.bind(liveController),
);
router.get(
  '/:topicId/livesession',
  authMiddleware_1.authMiddleware,
...
router.delete(
  '/livesession/:id',
  authMiddleware_1.authMiddleware,
  liveController.delete.bind(liveController),
);
