    ...
    constructor(service) {
        ...
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!firstKey)
                    res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ message: 'pdfKeys[0] required' });
                ...
                res.status(statusCode_1.HttpStatus.CREATED).json(Object.assign(Object.assign({}, obj), { pdfUrls: url ? [url] : [] }));
            }
            catch (e) {
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Internal server error' });
            }
        });
        this.getByTopic = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    getNoteUploadUrls(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield (0, s3Presign_1.presignPutObject)({ keyPrefix: 'notes', filename, contentType });
                res.json(data);
            }
            catch (err) {
                next(err);
