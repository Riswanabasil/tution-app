        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!tutorId || !summary || !education || !experience || !idProofKey || !resumeKey) {
                    res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ message: 'Missing required fields' });
                }
                const input = {
    ...
    googleLoginTutor(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { accessToken, refreshToken, tutor } = yield this.tutorService.googleLoginTutorService(idToken);
                const REFRESH_COOKIE = Number(process.env.MAX_AGE);
                ...
                res.status(statusCode_1.HttpStatus.UNAUTHORIZED).json({ message: err.message || 'Unauthorized' });
            }
        });
    }
    ...
    getProfileUploadUrl(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield (0, s3Presign_1.presignPutObject)({ keyPrefix: 'TutorPic', filename, contentType });
                res.json(data);
            }
            catch (err) {
                next(err);
