    ...
    getVideoUploadUrl(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield (0, s3Presign_1.presignPutObject)({ keyPrefix: 'Tutor-videos', filename, contentType });
                res.json(data);
            }
            catch (err) {
                next(err);
    ...
    createVideo(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.CREATED).json(Object.assign(Object.assign({}, obj), { url: signed }));
            }
            catch (err) {
                next(err);
            }
