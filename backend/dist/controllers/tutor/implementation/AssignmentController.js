...
class AssignmentController {
  constructor(assignmentService) {
      ...
      __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          res
            ...
            .json({ message: 'Failed to create assignment' });
        }
      });
    this.getAssignmentsByTopic = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const { topicId } = req.params;
    ...
    this.getAssignmentById = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const { id } = req.params;
          ...
          res
            .status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR)
            .json({ message: 'Failed to fetch assignment' });
        }
      });
    this.updateAssignment = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const { id } = req.params;
          ...
          res
            .status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR)
            .json({ message: 'Failed to update assignment' });
        }
      });
    this.deleteAssignment = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const { id } = req.params;
