...
class TopicController {
    constructor(service) {
        ...
        this.getByModule = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!topic) {
                    res.status(statusCode_1.HttpStatus.NOT_FOUND).json({ message: errorMessages_1.ERROR_MESSAGES.NOT_FOUND });
                    return;
                }
                res.json(topic);
            }
