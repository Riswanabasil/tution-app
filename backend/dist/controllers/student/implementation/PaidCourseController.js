...
class PaidCourseController {
  constructor(paidCourseService) {
    ...
    this.getModulesByCourse = (req, res) =>
  ...
  getTopicsByModule(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const result = yield this.paidCourseService.getTopicsByModuleId(
          moduleId,
          String(search),
          parseInt(page),
          parseInt(limit),
        ...
        res
          .status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR)
          .json({ message: 'Failed to fetch topics', err });
      }
    });
  }
  ...
  getNotes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        res
          .status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR)
          .json({ message: 'Failed to fetch notes' });
      }
    });
  }
}
