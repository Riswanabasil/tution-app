    ...
    constructor(svc) {
        ...
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const studentId = ((_a = req.user) === null || _a === void 0 ? void 0 : _a.id) || req.body.studentId;
                ...
                if (!(r >= 1 && r <= 5)) {
                    res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ message: 'rating must be between 1 and 5' });
                    return;
                }
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to create review' });
                return;
            }
        });
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to fetch review' });
                return;
            }
        });
        this.listByCourse = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to fetch reviews' });
            }
        });
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to update review' });
            }
        });
        this.remove = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to delete review' });
            }
        });
        this.stats = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.status(statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR).json({ message: 'Failed to fetch stats' });
            }
        });
        this.getMine = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
