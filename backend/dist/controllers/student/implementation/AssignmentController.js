...
class AssignmentController {
    ...
    generatePresignedUrl(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const q = req.query;
                const filename = ((_b = (_a = q.filename) !== null && _a !== void 0 ? _a : q.fileName) !== null && _b !== void 0 ? _b : '').toString().trim();
                const contentType = ((_c = q.contentType) !== null && _c !== void 0 ? _c : '').toString().trim();
    ...
    createSubmissionController(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const studentId = req.user.id;
                const data = req.body;
                const submission = yield this.assgnService.createSubmissionService(data, studentId, assignmentId);
    ...
    updateSubmissionByAssignment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const updated = yield this.assgnService.updateSubmissionByAssignment(assignmentId, studentId, { response, fileKey });
                res.status(statusCode_1.HttpStatus.OK).json(updated);
            }
            catch (err) {
                res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ error: errorMessages_1.ERROR_MESSAGES.BAD_REQUEST });
            }
        });
    }
}
