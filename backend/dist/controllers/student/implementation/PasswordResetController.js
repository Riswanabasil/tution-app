...
class PasswordResetController {
    ...
    forgotPassword(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(statusCode_1.HttpStatus.OK).json({ message: 'If that email exists, an OTP has been sent.' });
        });
    }
    verifyResetOtp(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.status(statusCode_1.HttpStatus.OK).json({ message: 'OTP verified. You can reset your password now.' });
            }
            catch (e) {
