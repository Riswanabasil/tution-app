    ...
    createOrder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { razorpayOrderId, currency, enrollmentId } = yield this.paymentService.createOrder(userId, courseId, amount);
                ...
                // }
                const status = (e === null || e === void 0 ? void 0 : e.status) === 409 ? 409 : statusCode_1.HttpStatus.INTERNAL_SERVER_ERROR;
                const message = (e === null || e === void 0 ? void 0 : e.status) === 409
    ...
    verifyPayment(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.paymentService.verifyAndUpdate(razorpay_payment_id, razorpay_order_id, razorpay_signature, courseId, userId);
    ...
    retryOrder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                console.error(' retryOrder error:', err);
                if (err instanceof errorHandler_1.AlreadyPaidError || err.name === 'AlreadyPaidError') {
                    res.status(statusCode_1.HttpStatus.CONFLICT).json({ message: err.message }); // 409
                    return;
                }
                ...
                if (err.message === 'Enrollment not found' ||
                    ...
                    res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ message: err.message });
                    return;
                }
                res.status(statusCode_1.HttpStatus.BAD_REQUEST).json({ message: errorMessages_1.ERROR_MESSAGES.BAD_REQUEST });
                return;
