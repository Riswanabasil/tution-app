...
const DEFAULT_EXPIRES = Number(
  (_a = process.env.S3_PRESIGN_EXPIRES_SECONDS) !== null && _a !== void 0 ? _a : 900,
);
...
function presignPutObject(_a) {
  return __awaiter(
    ...
    function* ({
      ...
      const uploadUrl = yield (0, s3_request_presigner_1.getSignedUrl)(s3Client_1.s3, cmd, {
        expiresIn,
      });
