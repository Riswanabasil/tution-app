...
class StudentRepository extends BaseRepository_1.BaseRepository {
  ...
  findMany(filter, options) {
    return __awaiter(this, void 0, void 0, function* () {
      return studentSchema_1.default
        .find(filter)
        .skip(options.skip || 0)
  ...
  updatePasswordByEmail(email, passwordHash) {
    return __awaiter(this, void 0, void 0, function* () {
      const res = yield studentSchema_1.default.updateOne(
        { email },
  ...
  getAuthStateById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      const doc = yield studentSchema_1.default.findById(id).select('isBlocked').lean();
