...
class CourseRepository {
    ...
    findMany(filter_1, _a) {
        return __awaiter(this, arguments, void 0, function* (filter, { skip, limit, sort = { createdAt: -1 } }) {
    ...
    countByStatusMap() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                approved: (_d = (_c = rows.find((r) => r._id === 'approved')) === null || _c === void 0 ? void 0 : _c.n) !== null && _d !== void 0 ? _d : 0,
                rejected: (_f = (_e = rows.find((r) => r._id === 'rejected')) === null || _e === void 0 ? void 0 : _e.n) !== null && _f !== void 0 ? _f : 0,
            };
        });
    }
    ...
    listByTutor(tutorId, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const docs = yield CourseSchema_1.Course.find(filter)
                ...
                .sort({ createdAt: -1 })
                .skip((_a = opts === null || opts === void 0 ? void 0 : opts.skip) !== null && _a !== void 0 ? _a : 0)
                .limit((_b = opts === null || opts === void 0 ? void 0 : opts.limit) !== null && _b !== void 0 ? _b : 20)
                .lean()
                .exec();
            return docs.map((d) => ({
                _id: String(d._id),
