...
class AssignmentRepository {
    ...
    findByTopic(topicId) {
        return __awaiter(this, void 0, void 0, function* () {
            return AssignmentModel_1.AssignmentModel.find({ topicId, isDeleted: false }).sort({ createdAt: -1 }).exec();
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    update(id, updateData) {
        return __awaiter(this, void 0, void 0, function* () {
            return AssignmentModel_1.AssignmentModel.findByIdAndUpdate(id, updateData, { new: true }).exec();
        });
    }
    softDelete(id) {
        return __awaiter(this, void 0, void 0, function* () {
