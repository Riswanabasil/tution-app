...
class ReviewRepository {
    ...
    listByCoursePaginated(courseId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [docs, total] = yield Promise.all([
                review_1.default.find({ courseId, isDeleted: false })
    ...
    update(id, updates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof updates.comment !== 'undefined')
                $set.comment = updates.comment;
            const doc = yield review_1.default.findOneAndUpdate({ _id: id, isDeleted: false }, { $set }, { new: true });
            return doc ? (0, review_2.toDTO)(doc) : null;
        });
    }
    softDelete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield review_1.default.updateOne({ _id: id, isDeleted: false }, { $set: { isDeleted: true } });
