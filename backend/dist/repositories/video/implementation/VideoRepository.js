...
class VideoRepository extends BaseRepository_1.BaseRepository {
  ...
  listByTopic(topicId) {
    return __awaiter(this, void 0, void 0, function* () {
      return VideoSchema_1.default
        .find({ topic: new mongoose_1.Types.ObjectId(topicId), isDeleted: false })
        .sort({ createdAt: -1 })
        .select(
          '_id tutor topic title description durationSec s3Key contentType createdAt updatedAt',
        )
        .lean()
        .exec();
    });
  ...
  softDelete(id) {
    return __awaiter(this, void 0, void 0, function* () {
      const res = yield VideoSchema_1.default.findByIdAndUpdate(
        id,
        { isDeleted: true },
        { new: true },
      );
