...
class StudentVideoProgressRepository extends BaseRepository_1.BaseRepository {
    ...
    upsertAndMerge(input) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const duration = (_b = (_a = input.durationSecDb) !== null && _a !== void 0 ? _a : input.durationSecHint) !== null && _b !== void 0 ? _b : 0;
            ...
            doc.lastPositionSec = Math.max((_c = doc.lastPositionSec) !== null && _c !== void 0 ? _c : 0, (_d = input.lastPositionSec) !== null && _d !== void 0 ? _d : 0);
            if (input.durationSecHint)
                doc.durationSecSnapshot = input.durationSecHint;
            doc.ranges = (0, progressUtils_1.mergeRanges)(doc.ranges || [], input.addRanges || [], duration);
            const { totalWatchedSec, percent, completed } = (0, progressUtils_1.recomputeProgress)({
                ranges: doc.ranges,
