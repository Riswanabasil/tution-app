...
class TutorRepository extends BaseRepository_1.BaseRepository {
    ...
    updateVerificationById(tutorId, verificationDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            return TutorSchema_1.default.findByIdAndUpdate(tutorId, {
    ...
    getTutorById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return TutorSchema_1.default.findById(id)
    ...
    updateById(id, updates) {
        return __awaiter(this, void 0, void 0, function* () {
            return TutorSchema_1.default.findByIdAndUpdate(id, updates, { new: true }).select('-password').lean().exec();
        });
    }
    ...
    findCoursesByTutor(tutorId) {
        return __awaiter(this, void 0, void 0, function* () {
            const courses = yield CourseSchema_1.Course.find({ tutor: tutorId }).select('title status').lean();
            //  aggregate
            return Promise.all(courses.map((c) => __awaiter(this, void 0, void 0, function* () {
    ...
    incrementWallet(tutorId, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            yield TutorSchema_1.default.findByIdAndUpdate(tutorId, { $inc: { walletBalance: amount } }, { new: true }).exec();
        });
    }
    countByStatusMap() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            const rows = yield (yield Promise.resolve().then(() => __importStar(require('../../../models/tutor/TutorSchema')))).default
                .aggregate([{ $group: { _id: '$status', n: { $sum: 1 } } }])
                .exec();
            return {
                pending: (_b = (_a = rows.find((r) => r._id === 'pending')) === null || _a === void 0 ? void 0 : _a.n) !== null && _b !== void 0 ? _b : 0,
                'verification-submitted': (_d = (_c = rows.find((r) => r._id === 'verification-submitted')) === null || _c === void 0 ? void 0 : _c.n) !== null && _d !== void 0 ? _d : 0,
                approved: (_f = (_e = rows.find((r) => r._id === 'approved')) === null || _e === void 0 ? void 0 : _e.n) !== null && _f !== void 0 ? _f : 0,
                rejected: (_h = (_g = rows.find((r) => r._id === 'rejected')) === null || _g === void 0 ? void 0 : _g.n) !== null && _h !== void 0 ? _h : 0,
            };
        });
    }
    findByIds(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            return TutorSchema_1.default.find({ _id: { $in: ids } })
    ...
    listByStatuses(statuses, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const docs = yield TutorSchema_1.default.find({ status: { $in: statuses } })
    ...
    getWalletBalance(tutorId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const doc = yield TutorSchema_1.default.findById(tutorId).select('walletBalance').lean().exec();
            return (_a = doc === null || doc === void 0 ? void 0 : doc.walletBalance) !== null && _a !== void 0 ? _a : 0;
        });
    }
}
