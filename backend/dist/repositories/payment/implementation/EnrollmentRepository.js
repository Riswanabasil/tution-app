...
class EnrollmentRepository extends BaseRepository_1.BaseRepository {
    ...
    updateStatus(orderId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            return Enrollment_1.EnrollmentModel.findOneAndUpdate({ razorpayOrderId: orderId }, { status }, { new: true });
        });
    }
    findByOrderId(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findOne(filter) {
        return __awaiter(this, void 0, void 0, function* () {
            return Enrollment_1.EnrollmentModel.findOne(filter).exec();
        });
    }
    ...
    sumPaidAmountInRange(range) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (_b = (_a = res[0]) === null || _a === void 0 ? void 0 : _a.total) !== null && _b !== void 0 ? _b : 0;
        });
    }
    sumPaidAmountToday() {
    ...
    countDistinctPaidUsersForCourses(range, courseIds) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!courseIds.length)
                return 0;
            const ids = yield Enrollment_1.EnrollmentModel.distinct('userId', (0, enrollment_1.matchPaid)(range, courseIds));
            return ids.length;
        });
    }
    countPaidForCourses(range, courseIds) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!courseIds.length)
                return 0;
            return Enrollment_1.EnrollmentModel.countDocuments((0, enrollment_1.matchPaid)(range, courseIds)).exec();
        });
    }
    ...
    recentPaidEnrollmentsForCourses(range, courseIds, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!courseIds.length)
                return [];
            const docs = yield Enrollment_1.EnrollmentModel.find((0, enrollment_1.matchPaid)(range, courseIds))
                .sort({ createdAt: -1 })
                .limit(limit)
            ...
            return docs.map((d) => {
                ...
                return ({
                    ...
                    studentName: (_b = (_a = d.userId) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : '',
                    studentEmail: (_d = (_c = d.userId) === null || _c === void 0 ? void 0 : _c.email) !== null && _d !== void 0 ? _d : '',
                    courseId: String((_f = (_e = d.courseId) === null || _e === void 0 ? void 0 : _e._id) !== null && _f !== void 0 ? _f : d.courseId),
                    courseTitle: (_h = (_g = d.courseId) === null || _g === void 0 ? void 0 : _g.title) !== null && _h !== void 0 ? _h : '',
                    courseCode: (_k = (_j = d.courseId) === null || _j === void 0 ? void 0 : _j.code) !== null && _k !== void 0 ? _k : '',
                    amount: d.amount,
                });
            });
        });
    ...
    upsertPending(userId, courseId, amount, razorpayOrderId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield Enrollment_1.EnrollmentModel.findOneAndUpdate({ userId, courseId, status: 'pending' }, {
    ...
    isPurchased(userId, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            return !!(yield Enrollment_1.EnrollmentModel.exists({ userId, courseId, status: 'paid' }).lean());
        });
    }
}
